...
import org.apache.shardingsphere.sql.parser.autogen.DamengStatementParser.AlterResourceCostContext;
 ...
 */
@NoArgsConstructor
public final class DamengDALStatementSQLVisitor extends DamengStatementSQLVisitor implements DALSQLVisitor, SQLStatementVisitor {
    
    public DamengDALStatementSQLVisitor(final Properties props) {
        super(props);
    }
